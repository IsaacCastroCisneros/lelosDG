                ...
                <div className="w-full lg:w-[70%] xl:w-[70%] 2xl:w-[70%] ">
                    ...
                    <div className='mt-10 grid grid-cols-[repeat(auto-fill,minmax(17.3rem,1fr))] gap-5'>
                        <div className='bg-[#ffc107] rounded-md w-[280px] h-[376px] mx-auto p-7 text-black'>
                            <Image src="/img/icons/12anos.webp" alt='Desarrollo Global' width="210" height="66" className='py-5' />
                        ...
                        <div className='bg-[#dc3545] rounded-md w-[280px] h-[376px] mx-auto p-7'>
                            <Image src="/img/icons/IconIsoDiploma.webp" alt='Desarrollo Global' width="210" height="66"/>
                        ...
                        <div className='bg-[#282828] rounded-md w-[280px] h-[376px] mx-auto p-7'>
                            <Image src="/img/icons/CertificadoDiploma.webp" alt='Desarrollo Global' width="117" height="86" />
                        ...
                        <div className='bg-white text-black rounded-md w-[280px] h-[376px] mx-auto p-7'>
                            <Image src="/img/icons/IconDocentesDiploma.webp" alt='Desarrollo Global' width="95" height="91" className='py-5' />
                        ...
                        <div className='bg-white text-black rounded-md w-[280px] h-[376px] mx-auto p-7'>
                            <Image src="/img/icons/IconSoporteDiploma.webp" alt='Desarrollo Global' width="72" height="89" className='my-5' />
                        ...
                        <div className='bg-white text-black rounded-md w-[280px] h-[376px] mx-auto p-7'>
                            <Image src="/img/icons/IconPcDiplomas.webp" alt='Desarrollo Global' width="117" height="86" className='py-5' />
